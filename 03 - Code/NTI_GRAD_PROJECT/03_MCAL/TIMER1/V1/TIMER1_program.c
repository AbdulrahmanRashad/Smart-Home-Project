...
static void (*ptrs) (void) = {NULL};
static void (*ptrs1) (void) = {NULL};
/******************************************************************************
* !comment  :  Module Global Variable.  							          *
******************************************************************************/

static volatile uint_16 Global_u16Time1;
static volatile uint_16 Global_u16Time2;
static volatile uint_16 Global_u16Time3;
static volatile uint_16 Global_u16Flag = 0;
